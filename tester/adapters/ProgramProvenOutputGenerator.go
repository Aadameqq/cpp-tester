...
type ProgramProvenOutputGenerator struct {
...
func (og ProgramProvenOutputGenerator) Generate(input string, sendResult chan testerCore.Result) {
	...
	timeoutResult := testerCore.ConstructResultWithError(ProvenSolutionTimeoutResultError)
